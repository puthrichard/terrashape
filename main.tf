...
variable "obj" {
    description = "Object with cidr_block and name"
}
...
resource "aws_subnet" "subnet_1" {
    vpc_id = aws_vpc.prod_vpc.id
    cidr_block = var.obj[0].cidr_block
...
resource "aws_subnet" "subnet_2" {
    vpc_id = aws_vpc.prod_vpc.id
    cidr_block = var.obj[1].cidr_block
    availability_zone = "us-east-2a"
...
# Associate subnet with Rotue Table
...
# Create Ubun tu server and install/enable apache2
